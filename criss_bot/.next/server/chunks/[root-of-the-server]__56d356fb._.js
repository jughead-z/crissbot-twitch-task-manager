...
async function GET() {
    try {
        const tasks = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllTasks"])();
        const response = {
            success: true,
            data: tasks
        };
...
async function POST(request) {
    try {
        ...
        const newTask = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addTask"])({
            text: text.trim(),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__56d356fb._.js.map