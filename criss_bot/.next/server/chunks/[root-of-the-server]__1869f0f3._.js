...
async function GET() {
    try {
        const pomodoroState = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPomodoroState"])();
        // Calculate next break type
        const currentSession = pomodoroState.mode === "work" ? pomodoroState.session : pomodoroState.session - 1;
        ...
        console.error("❌ Get Pomodoro state error:", error);
        const response = {
            success: false,
...
async function POST(request) {
    try {
        ...
        const newState = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updatePomodoroState"])({
            isActive: true,
        ...
        if (io) {
            io.emit("pomodoroStarted", newState);
        }
        const response = {
            success: true,
            data: newState,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1869f0f3._.js.map